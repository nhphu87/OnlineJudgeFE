    ...
    <div class="content markdown-body">
      <ul>
        <li>{{$t('m.Where_is_the_input_and_the_output')}} 
          <p> Tùy vào yêu cầu dữ liệu vào/ra của đề bài mà ta chọn cách nhập và xuất dữ liệu.</p> 
          <p>
            Nếu bài để chế độ I/O là Standard IO thì chương trình của bạn sẽ nhận đầu vào từ <code>stdin</code> ('Standard Input') và xuất ra ở <code>stdout</code> ('Standard Output') Ví dụ, bạn có thể dùng scanf trong C hoặc cin trong C++ để đọc từ stdin, và sử dụng printf trong C hoặc cout trong C++ để xuất ra ở stdout.
	  </p>
          <p>
            Nếu bài để chế độ I/O là File IO thì chương trình của bạn sẽ nhận đầu vào từ file và xuất ra ở file theo đúng tên và định dạng của file input và file output, chú ý có phân biệt in hoa, in thường.
          </p>
        </li>
        <li>Điểm chuyên cần là gì?
          ...
          <div>
            ...
            <p>Hệ thống chia làm 7 cấp danh hiệu, từ 0 - 6 và mỗi danh hiệu này sẽ có màu sắc riêng</p>
          </div>
        </li>
        ...
        <li>{{$t('m.How_to_report_bugs')}}
          <p>{{$t('m.How_to_report_bugs_answer_part_1')}} mesenger: nghoangphu hoặc zalo: 0917699599
