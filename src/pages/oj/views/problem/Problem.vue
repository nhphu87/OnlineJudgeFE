...
<template>
  <div class="flex-container">
          ...
          <Col :span="10">
            <div class="status" v-if="statusVisible">
              <template v-if="!this.contestID || (this.contestID && OIContestRealTimePermission)">
                ...
                <Tag type="dot" :color="submissionStatus.color" title="Click để xem chi tiết" @click.native="handleRoute('/status/'+submissionId+'?problem=' + problem._id + '&contest=' + contestID)">
    ...
    <div id="right-column">
      ...
      <Card v-if="!this.contestID" style="margin-top: 20px;" :padding="0">
